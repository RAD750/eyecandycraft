...
public abstract class TrackInstanceBase implements ITrackInstance {
    ...
    public void onNeighborBlockChange(int id) {
        ...
        if (id > 0 && Block.blocksList[id].canProvidePower() && isFlexibleRail() && RailLogic.getAdjacentTrackCount(new RailLogic(blockTrack, getWorld(), tileEntity.xCoord, tileEntity.yCoord, tileEntity.zCoord)) == 3) {
            switchTrack(false);
        }
        testPower();
    }
