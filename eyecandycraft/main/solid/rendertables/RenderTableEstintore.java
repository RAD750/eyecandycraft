...
public class RenderTableEstintore extends TileEntitySpecialRenderer {
	private ModelEstintore Estintore;

	public RenderTableEstintore() {
		Estintore = new ModelEstintore();
	}
	...
	public void renderTileEntityAt(TileEntity tileentity, double x, double y, double z, float scale) {
		...
		if (tileentity.getWorldObj().getBlockId(tileentity.xCoord, tileentity.yCoord,
				tileentity.zCoord) == Blocks.Estintore.blockID) {
		...
		bindTextureByName("/eyecandycraft/textures/Estintore.png");
		Estintore.render((Entity) null, 0.0F, -0.1F, 0.0F, 0.0F, 0.0F, 0.0625F);
