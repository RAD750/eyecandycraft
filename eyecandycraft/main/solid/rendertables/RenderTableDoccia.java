...
import eyecandycraft.main.solid.models.ModelDoccia;

public class RenderTableDoccia extends TileEntitySpecialRenderer {
	private ModelDoccia Doccia;

	public RenderTableDoccia() {
		Doccia = new ModelDoccia();
	}
	...
	public void renderTileEntityAt(TileEntity tileentity, double x, double y, double z, float scale) {
		...
		if (tileentity.getWorldObj().getBlockId(tileentity.xCoord, tileentity.yCoord,
				tileentity.zCoord) == Blocks.Doccia.blockID) {
		...
		bindTextureByName("/eyecandycraft/textures/Doccia.png");
		Doccia.render((Entity) null, 0.0F, -0.1F, 0.0F, 0.0F, 0.0F, 0.0625F);
