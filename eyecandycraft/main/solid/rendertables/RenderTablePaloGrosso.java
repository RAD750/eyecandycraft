...
import eyecandycraft.main.solid.models.ModelPaloGrosso;

public class RenderTablePaloGrosso extends TileEntitySpecialRenderer {
	private ModelPaloGrosso PaloGrosso;

	public RenderTablePaloGrosso() {
		PaloGrosso = new ModelPaloGrosso();
	}
	...
	public void renderTileEntityAt(TileEntity tileentity, double x, double y, double z, float scale) {
		...
		if (tileentity.getWorldObj().getBlockId(tileentity.xCoord, tileentity.yCoord,
				tileentity.zCoord) == Blocks.PaloGrosso.blockID) {
		...
		bindTextureByName("/eyecandycraft/textures/PaloGrosso.png");
		PaloGrosso.render((Entity) null, 0.0F, -0.1F, 0.0F, 0.0F, 0.0F, 0.0625F);
