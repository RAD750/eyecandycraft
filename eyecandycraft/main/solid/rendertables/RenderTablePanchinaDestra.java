...
import eyecandycraft.main.solid.models.ModelPanchinaDestra;

public class RenderTablePanchinaDestra extends TileEntitySpecialRenderer {
	private ModelPanchinaDestra PanchinaDestra;

	public RenderTablePanchinaDestra() {
		PanchinaDestra = new ModelPanchinaDestra();
	}
	...
	public void renderTileEntityAt(TileEntity tileentity, double x, double y, double z, float scale) {
		...
		if (tileentity.getWorldObj().getBlockId(tileentity.xCoord, tileentity.yCoord,
				tileentity.zCoord) == Blocks.PanchinaDestra.blockID) {
		...
		PanchinaDestra.render((Entity) null, 0.0F, -0.1F, 0.0F, 0.0F, 0.0F, 0.0625F);
