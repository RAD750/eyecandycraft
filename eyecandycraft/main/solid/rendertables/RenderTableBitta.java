...
import eyecandycraft.main.solid.models.ModelBitta;

public class RenderTableBitta extends TileEntitySpecialRenderer {
	private ModelBitta Bitta;

	public RenderTableBitta() {
		Bitta = new ModelBitta();
	}
	...
	public void renderTileEntityAt(TileEntity tileentity, double x, double y, double z, float scale) {
		...
		if (tileentity.getWorldObj().getBlockId(tileentity.xCoord, tileentity.yCoord,
				tileentity.zCoord) == Blocks.Bitta.blockID) {
		...
		bindTextureByName("/eyecandycraft/textures/Bitta.png");
		Bitta.render((Entity) null, 0.0F, -0.1F, 0.0F, 0.0F, 0.0F, 0.0625F);
