...
import eyecandycraft.main.solid.models.ModelPolycom;

public class RenderTablePolycom extends TileEntitySpecialRenderer {
	private ModelPolycom Polycom;

	public RenderTablePolycom() {
		Polycom = new ModelPolycom();
	}
	...
	public void renderTileEntityAt(TileEntity tileentity, double x, double y, double z, float scale) {
		...
		if (tileentity.getWorldObj().getBlockId(tileentity.xCoord, tileentity.yCoord,
				tileentity.zCoord) == Blocks.Polycom.blockID) {
		...
		bindTextureByName("/eyecandycraft/textures/Polycom.png");
		Polycom.render((Entity) null, 0.0F, -0.1F, 0.0F, 0.0F, 0.0F, 0.0625F);
