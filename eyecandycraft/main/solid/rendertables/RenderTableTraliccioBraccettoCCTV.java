...
import eyecandycraft.main.solid.models.ModelTraliccioBraccettoCCTV;
import eyecandycraft.main.utils.Game;

public class RenderTableTraliccioBraccettoCCTV extends TileEntitySpecialRenderer {
    private final ModelTraliccioBraccettoCCTV TraliccioBraccettoCCTV;
    ...
    public void renderTileEntityAt(TileEntity tileentity, double x, double y, double z, float scale) {
        ...
        TraliccioBraccettoCCTV.render(null, 0.0F, -0.1F, 0.0F, 0.0F, 0.0F, 0.0625F);
