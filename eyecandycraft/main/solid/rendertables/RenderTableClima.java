...
import eyecandycraft.main.solid.models.ModelClima;

public class RenderTableClima extends TileEntitySpecialRenderer {
	private ModelClima Clima;

	public RenderTableClima() {
		Clima = new ModelClima();
	}
	...
	public void renderTileEntityAt(TileEntity tileentity, double x, double y, double z, float scale) {
		...
		if (tileentity.getWorldObj().getBlockId(tileentity.xCoord, tileentity.yCoord,
				tileentity.zCoord) == Blocks.Clima.blockID) {
		...
		bindTextureByName("/eyecandycraft/textures/Clima.png");
		Clima.render((Entity) null, 0.0F, -0.1F, 0.0F, 0.0F, 0.0F, 0.0625F);
