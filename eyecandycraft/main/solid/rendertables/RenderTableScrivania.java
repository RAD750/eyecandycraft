...
import eyecandycraft.main.solid.models.ModelScrivania;

public class RenderTableScrivania extends TileEntitySpecialRenderer {
	private ModelScrivania Scrivania;

	public RenderTableScrivania() {
		Scrivania = new ModelScrivania();
	}
	...
	public void renderTileEntityAt(TileEntity tileentity, double x, double y, double z, float scale) {
		...
		if (tileentity.getWorldObj().getBlockId(tileentity.xCoord, tileentity.yCoord,
				tileentity.zCoord) == Blocks.Scrivania.blockID) {
		...
		bindTextureByName("/eyecandycraft/textures/Scrivania.png");
		Scrivania.render((Entity) null, 0.0F, -0.1F, 0.0F, 0.0F, 0.0F, 0.0625F);
