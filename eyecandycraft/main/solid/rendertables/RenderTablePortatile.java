...
import eyecandycraft.main.solid.models.ModelPortatile;

public class RenderTablePortatile extends TileEntitySpecialRenderer {
	private ModelPortatile Portatile;

	public RenderTablePortatile() {
		Portatile = new ModelPortatile();
	}
	...
	public void renderTileEntityAt(TileEntity tileentity, double x, double y, double z, float scale) {
		...
		if (tileentity.getWorldObj().getBlockId(tileentity.xCoord, tileentity.yCoord,
				tileentity.zCoord) == Blocks.Portatile.blockID) {
		...
		bindTextureByName("/eyecandycraft/textures/Portatile.png");
		Portatile.render((Entity) null, 0.0F, -0.1F, 0.0F, 0.0F, 0.0F, 0.0625F);
