...
import eyecandycraft.main.solid.models.ModelTVLCD;

public class RenderTableTVLCD extends TileEntitySpecialRenderer {
	private ModelTVLCD TVLCD;

	public RenderTableTVLCD() {
		TVLCD = new ModelTVLCD();
	}
	...
	public void renderTileEntityAt(TileEntity tileentity, double x, double y, double z, float scale) {
		...
		if (tileentity.getWorldObj().getBlockId(tileentity.xCoord, tileentity.yCoord,
				tileentity.zCoord) == Blocks.TVLCD.blockID) {
		...
		bindTextureByName("/eyecandycraft/textures/TVLCD.png");
		TVLCD.render((Entity) null, 0.0F, -0.1F, 0.0F, 0.0F, 0.0F, 0.0625F);
