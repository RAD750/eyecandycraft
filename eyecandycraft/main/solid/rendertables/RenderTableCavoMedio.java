...
import eyecandycraft.main.solid.models.ModelCavoMedio;

public class RenderTableCavoMedio extends TileEntitySpecialRenderer {
	private ModelCavoMedio CavoMedio;

	public RenderTableCavoMedio() {
		CavoMedio = new ModelCavoMedio();
	}
	...
	public void renderTileEntityAt(TileEntity tileentity, double x, double y, double z, float scale) {
		...
		if (tileentity.getWorldObj().getBlockId(tileentity.xCoord, tileentity.yCoord,
				tileentity.zCoord) == Blocks.CavoMedio.blockID) {
		...
		CavoMedio.render((Entity) null, 0.0F, -0.1F, 0.0F, 0.0F, 0.0F, 0.0625F);
