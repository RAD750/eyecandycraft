...
import eyecandycraft.main.solid.models.ModelAntennaFMDipolo;

public class RenderTableAntennaFMDipolo extends TileEntitySpecialRenderer {
	private ModelAntennaFMDipolo AntennaFMDipolo;

	public RenderTableAntennaFMDipolo() {
		AntennaFMDipolo = new ModelAntennaFMDipolo();
	}
	...
	public void renderTileEntityAt(TileEntity tileentity, double x, double y, double z, float scale) {
		...
		if (tileentity.getWorldObj().getBlockId(tileentity.xCoord, tileentity.yCoord,
				tileentity.zCoord) == Blocks.AntennaFMDipolo.blockID) {
		...
		bindTextureByName("/eyecandycraft/textures/AntennaFMDipolo.png");
		AntennaFMDipolo.render((Entity) null, 0.0F, -0.1F, 0.0F, 0.0F, 0.0F, 0.0625F);
