...
import eyecandycraft.main.solid.models.ModelLanterna;

public class RenderTableLanterna extends TileEntitySpecialRenderer {
	private ModelLanterna Lanterna;

	public RenderTableLanterna() {
		Lanterna = new ModelLanterna();
	}
	...
	public void renderTileEntityAt(TileEntity tileentity, double x, double y, double z, float scale) {
		...
		if (tileentity.getWorldObj().getBlockId(tileentity.xCoord, tileentity.yCoord,
				tileentity.zCoord) == Blocks.Lanterna.blockID) {
		...
		bindTextureByName("/eyecandycraft/textures/Lanterna.png");
		Lanterna.render((Entity) null, 0.0F, -0.1F, 0.0F, 0.0F, 0.0F, 0.0625F);
