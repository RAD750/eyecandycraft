...
import eyecandycraft.main.solid.models.ModelPaloCimaDoppio;

public class RenderTablePaloCimaDoppio extends TileEntitySpecialRenderer {
	private ModelPaloCimaDoppio PaloCimaDoppio;

	public RenderTablePaloCimaDoppio() {
		PaloCimaDoppio = new ModelPaloCimaDoppio();
	}
	...
	public void renderTileEntityAt(TileEntity tileentity, double x, double y, double z, float scale) {
		...
		if (tileentity.getWorldObj().getBlockId(tileentity.xCoord, tileentity.yCoord,
				tileentity.zCoord) == Blocks.PaloCimaDoppio.blockID) {
		...
		PaloCimaDoppio.render((Entity) null, 0.0F, -0.1F, 0.0F, 0.0F, 0.0F, 0.0625F);
