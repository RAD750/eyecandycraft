...
import eyecandycraft.main.solid.models.ModelPersiane;

public class RenderTablePersiane extends TileEntitySpecialRenderer {
	private ModelPersiane Persiane;

	public RenderTablePersiane() {
		Persiane = new ModelPersiane();
	}
	...
	public void renderTileEntityAt(TileEntity tileentity, double x, double y, double z, float scale) {
		...
		if (tileentity.getWorldObj().getBlockId(tileentity.xCoord, tileentity.yCoord,
				tileentity.zCoord) == Blocks.Persiane.blockID) {
		...
		Persiane.render((Entity) null, 0.0F, -0.1F, 0.0F, 0.0F, 0.0F, 0.0625F);
