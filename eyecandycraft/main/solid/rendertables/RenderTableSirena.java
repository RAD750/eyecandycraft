...
import eyecandycraft.main.solid.models.ModelSirena;

public class RenderTableSirena extends TileEntitySpecialRenderer {
	private ModelSirena Sirena;

	public RenderTableSirena() {
		Sirena = new ModelSirena();
	}
	...
	public void renderTileEntityAt(TileEntity tileentity, double x, double y, double z, float scale) {
		...
		if (tileentity.getWorldObj().getBlockId(tileentity.xCoord, tileentity.yCoord,
				tileentity.zCoord) == Blocks.Sirena.blockID) {
		...
		bindTextureByName("/eyecandycraft/textures/Sirena.png");
		Sirena.render((Entity) null, 0.0F, -0.1F, 0.0F, 0.0F, 0.0F, 0.0625F);
