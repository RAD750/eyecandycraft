...
import eyecandycraft.main.solid.models.ModelSbarraAlzata;

public class RenderTableSbarraAlzata extends TileEntitySpecialRenderer {
	private ModelSbarraAlzata SbarraAlzata;

	public RenderTableSbarraAlzata() {
		SbarraAlzata = new ModelSbarraAlzata();
	}
	...
	public void renderTileEntityAt(TileEntity tileentity, double x, double y, double z, float scale) {
		...
		if (tileentity.getWorldObj().getBlockId(tileentity.xCoord, tileentity.yCoord,
				tileentity.zCoord) == Blocks.SbarraAlzata.blockID) {
		...
		//L11.glRotatef(90.0F, 0.0F, 1.0F, 0.0F);

		GL11.glRotatef(direction * 90, 0.0F, 1.0F, 0.0F);

		bindTextureByName("/eyecandycraft/textures/Sbarra.png");
		SbarraAlzata.render((Entity) null, 0.0F, -0.1F, 0.0F, 0.0F, 0.0F, 0.0625F);
