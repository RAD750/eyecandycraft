...
import eyecandycraft.main.solid.models.ModelScalettaMuro;

public class RenderTableScalettaMuro extends TileEntitySpecialRenderer {
	private ModelScalettaMuro ScalettaMuro;

	public RenderTableScalettaMuro() {
		ScalettaMuro = new ModelScalettaMuro();
	}
	...
	public void renderTileEntityAt(TileEntity tileentity, double x, double y, double z, float scale) {
		...
		if (tileentity.getWorldObj().getBlockId(tileentity.xCoord, tileentity.yCoord,
				tileentity.zCoord) == Blocks.ScalettaMuro.blockID) {
		...
		bindTextureByName("/eyecandycraft/textures/ScalettaMuro.png");
		ScalettaMuro.render((Entity) null, 0.0F, -0.1F, 0.0F, 0.0F, 0.0F, 0.0625F);
