...
import eyecandycraft.main.solid.models.ModelCCTVCamPTZ;

public class RenderTableCCTVCamPTZ extends TileEntitySpecialRenderer {
	private ModelCCTVCamPTZ CCTVCamPTZ;

	public RenderTableCCTVCamPTZ() {
		CCTVCamPTZ = new ModelCCTVCamPTZ();
	}
	...
	public void renderTileEntityAt(TileEntity tileentity, double x, double y, double z, float scale) {
		...
		if (tileentity.getWorldObj().getBlockId(tileentity.xCoord, tileentity.yCoord,
				tileentity.zCoord) == Blocks.CCTVCamPTZ.blockID) {
		...
		bindTextureByName("/eyecandycraft/textures/CCTVCamPTZ.png");
		CCTVCamPTZ.render((Entity) null, 0.0F, -0.1F, 0.0F, 0.0F, 0.0F, 0.0625F);
