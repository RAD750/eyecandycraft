...
import eyecandycraft.main.solid.models.ModelROE;

public class RenderTableROE extends TileEntitySpecialRenderer {
	private ModelROE ROE;

	public RenderTableROE() {
		ROE = new ModelROE();
	}
	...
	public void renderTileEntityAt(TileEntity tileentity, double x, double y, double z, float scale) {
		...
		if (tileentity.getWorldObj().getBlockId(tileentity.xCoord, tileentity.yCoord,
				tileentity.zCoord) == Blocks.ROE.blockID) {
		...
		bindTextureByName("/eyecandycraft/textures/ROE.png");
		ROE.render((Entity) null, 0.0F, -0.1F, 0.0F, 0.0F, 0.0F, 0.0625F);
