...
import eyecandycraft.main.solid.models.ModelTraliccioBraccettoSat;

public class RenderTableTraliccioBraccettoSat extends TileEntitySpecialRenderer {
    private final ModelTraliccioBraccettoSat TraliccioBraccettoSat;
    ...
    public void renderTileEntityAt(TileEntity var1, double x, double y, double z, float scale) {
        ...
        TraliccioBraccettoSat.render(null, 0.0F, -0.1F, 0.0F, 0.0F, 0.0F, 0.0625F);
        GL11.glPopMatrix();
    }
}