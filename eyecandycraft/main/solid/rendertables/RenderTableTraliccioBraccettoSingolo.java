...
import eyecandycraft.main.solid.models.ModelTraliccioBraccettoSingolo;

public class RenderTableTraliccioBraccettoSingolo extends TileEntitySpecialRenderer {
	private ModelTraliccioBraccettoSingolo TraliccioBraccettoSingolo;

	public RenderTableTraliccioBraccettoSingolo() {
		TraliccioBraccettoSingolo = new ModelTraliccioBraccettoSingolo();
	}
	...
	public void renderTileEntityAt(TileEntity tileentity, double x, double y, double z, float scale) {
		...
		if (tileentity.getWorldObj().getBlockId(tileentity.xCoord, tileentity.yCoord,
				tileentity.zCoord) == Blocks.TraliccioBraccettoSingolo.blockID) {
		...
		TraliccioBraccettoSingolo.render((Entity) null, 0.0F, -0.1F, 0.0F, 0.0F, 0.0F, 0.0625F);
