...
import eyecandycraft.main.solid.models.ModelMiniARLO;

public class RenderTableMiniARLO extends TileEntitySpecialRenderer {
	private ModelMiniARLO MiniARLO;

	public RenderTableMiniARLO() {
		MiniARLO = new ModelMiniARLO();
	}
	...
	public void renderTileEntityAt(TileEntity tileentity, double x, double y, double z, float scale) {
		...
		if (tileentity.getWorldObj().getBlockId(tileentity.xCoord, tileentity.yCoord,
				tileentity.zCoord) == Blocks.MiniARLO.blockID) {
		...
		bindTextureByName("/eyecandycraft/textures/MiniARLO.png");
		MiniARLO.render((Entity) null, 0.0F, -0.1F, 0.0F, 0.0F, 0.0F, 0.0625F);
