...
import eyecandycraft.main.solid.models.ModelCartelloEndor;

public class RenderTableCartelloEndor extends TileEntitySpecialRenderer {
	private ModelCartelloEndor CartelloEndor;

	public RenderTableCartelloEndor() {
		CartelloEndor = new ModelCartelloEndor();
	}
	...
	public void renderTileEntityAt(TileEntity tileentity, double x, double y, double z, float scale) {
		...
		if (tileentity.getWorldObj().getBlockId(tileentity.xCoord, tileentity.yCoord,
				tileentity.zCoord) == Blocks.CartelloEndor.blockID) {
		...
		bindTextureByName("/eyecandycraft/textures/CartelloEndor.png");
		CartelloEndor.render((Entity) null, 0.0F, -0.1F, 0.0F, 0.0F, 0.0F, 0.0625F);
