...
public class RenderTableAntennaVDipole extends TileEntitySpecialRenderer {
	private ModelAntennaVDipole AntennaVDipole;
	...
	public void renderTileEntityAt(TileEntity tileentity, double x, double y, double z, float scale) {
		...
		if (tileentity.getWorldObj().getBlockId(tileentity.xCoord, tileentity.yCoord,
				tileentity.zCoord) == Blocks.AntennaVDipole.blockID) {
		...
		AntennaVDipole.render((Entity) null, 0.0F, -0.1F, 0.0F, 0.0F, 0.0F, 0.0625F);
