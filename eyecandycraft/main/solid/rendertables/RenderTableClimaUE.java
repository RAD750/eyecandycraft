...
import eyecandycraft.main.solid.models.ModelClimaUE;

public class RenderTableClimaUE extends TileEntitySpecialRenderer {
	private ModelClimaUE ClimaUE;

	public RenderTableClimaUE() {
		ClimaUE = new ModelClimaUE();
	}
	...
	public void renderTileEntityAt(TileEntity tileentity, double x, double y, double z, float scale) {
		...
		if (tileentity.getWorldObj().getBlockId(tileentity.xCoord, tileentity.yCoord,
				tileentity.zCoord) == Blocks.ClimaUE.blockID) {
		...
		bindTextureByName("/eyecandycraft/textures/ClimaUE.png");
		ClimaUE.render((Entity) null, 0.0F, -0.1F, 0.0F, 0.0F, 0.0F, 0.0625F);
