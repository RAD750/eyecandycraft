...
import eyecandycraft.main.solid.models.ModelPaloScaletta;

public class RenderTablePaloScaletta extends TileEntitySpecialRenderer {
	private ModelPaloScaletta PaloScaletta;

	public RenderTablePaloScaletta() {
		PaloScaletta = new ModelPaloScaletta();
	}
	...
	public void renderTileEntityAt(TileEntity tileentity, double x, double y, double z, float scale) {
		...
		if (tileentity.getWorldObj().getBlockId(tileentity.xCoord, tileentity.yCoord,
				tileentity.zCoord) == Blocks.PaloScaletta.blockID) {
		...
		bindTextureByName("/eyecandycraft/textures/PaloScaletta.png");
		PaloScaletta.render((Entity) null, 0.0F, -0.1F, 0.0F, 0.0F, 0.0F, 0.0625F);
