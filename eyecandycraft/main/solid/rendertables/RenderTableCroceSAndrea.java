...
import eyecandycraft.main.solid.models.ModelCroceSAndrea;

public class RenderTableCroceSAndrea extends TileEntitySpecialRenderer {
	private ModelCroceSAndrea CroceSAndrea;

	public RenderTableCroceSAndrea() {
		CroceSAndrea = new ModelCroceSAndrea();
	}
	...
	public void renderTileEntityAt(TileEntity tileentity, double x, double y, double z, float scale) {
		...
		if (tileentity.getWorldObj().getBlockId(tileentity.xCoord, tileentity.yCoord,
				tileentity.zCoord) == Blocks.CroceSAndrea.blockID) {
		...
		bindTextureByName("/eyecandycraft/textures/CroceSAndrea.png");
		CroceSAndrea.render((Entity) null, 0.0F, -0.1F, 0.0F, 0.0F, 0.0F, 0.0625F);
