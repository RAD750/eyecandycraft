...
import eyecandycraft.main.solid.models.ModelTraliccioBraccettoParabola;

public class RenderTableTraliccioBraccettoParabola extends TileEntitySpecialRenderer {
	private ModelTraliccioBraccettoParabola TraliccioBraccettoParabola;

	public RenderTableTraliccioBraccettoParabola() {
		TraliccioBraccettoParabola = new ModelTraliccioBraccettoParabola();
	}
	...
	public void renderTileEntityAt(TileEntity tileentity, double x, double y, double z, float scale) {
		...
		if (tileentity.getWorldObj().getBlockId(tileentity.xCoord, tileentity.yCoord,
				tileentity.zCoord) == Blocks.TraliccioBraccettoParabola.blockID) {
		...
		TraliccioBraccettoParabola.render((Entity) null, 0.0F, -0.1F, 0.0F, 0.0F, 0.0F, 0.0625F);
