...
import eyecandycraft.main.solid.models.ModelEstensioneBTS;

public class RenderTableEstensioneBTS extends TileEntitySpecialRenderer {
	private ModelEstensioneBTS EstensioneBTS;

	public RenderTableEstensioneBTS() {
		EstensioneBTS = new ModelEstensioneBTS();
	}
	...
	public void renderTileEntityAt(TileEntity tileentity, double x, double y, double z, float scale) {
		...
		if (tileentity.getWorldObj().getBlockId(tileentity.xCoord, tileentity.yCoord,
				tileentity.zCoord) == Blocks.EstensioneBTS.blockID) {
		...
		EstensioneBTS.render((Entity) null, 0.0F, -0.1F, 0.0F, 0.0F, 0.0F, 0.0625F);
