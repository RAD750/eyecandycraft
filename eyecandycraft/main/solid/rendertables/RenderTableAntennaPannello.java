...
import eyecandycraft.main.solid.models.ModelAntennaPannello;

public class RenderTableAntennaPannello extends TileEntitySpecialRenderer {
	private ModelAntennaPannello AntennaPannello;

	public RenderTableAntennaPannello() {
		AntennaPannello = new ModelAntennaPannello();
	}
	...
	public void renderTileEntityAt(TileEntity tileentity, double x, double y, double z, float scale) {
		...
		if (tileentity.getWorldObj().getBlockId(tileentity.xCoord, tileentity.yCoord,
				tileentity.zCoord) == Blocks.AntennaPannello.blockID) {
		...
		bindTextureByName("/eyecandycraft/textures/AntennaPannello.png");
		AntennaPannello.render((Entity) null, 0.0F, -0.1F, 0.0F, 0.0F, 0.0F, 0.0625F);
