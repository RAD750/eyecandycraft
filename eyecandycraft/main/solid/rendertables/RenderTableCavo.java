...
import eyecandycraft.main.solid.models.ModelCavo;

public class RenderTableCavo extends TileEntitySpecialRenderer {
	private ModelCavo Cavo;

	public RenderTableCavo() {
		Cavo = new ModelCavo();
	}
	...
	public void renderTileEntityAt(TileEntity tileentity, double x, double y, double z, float scale) {
		...
		if (tileentity.getWorldObj().getBlockId(tileentity.xCoord, tileentity.yCoord,
				tileentity.zCoord) == Blocks.Cavo.blockID) {
		...
		Cavo.render((Entity) null, 0.0F, -0.1F, 0.0F, 0.0F, 0.0F, 0.0625F);
