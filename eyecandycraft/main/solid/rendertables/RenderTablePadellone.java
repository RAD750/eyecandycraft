...
import eyecandycraft.main.solid.models.ModelPadellone;

public class RenderTablePadellone extends TileEntitySpecialRenderer {
	private ModelPadellone Padellone;

	public RenderTablePadellone() {
		Padellone = new ModelPadellone();
	}
	...
	public void renderTileEntityAt(TileEntity tileentity, double x, double y, double z, float scale) {
		...
		if (tileentity.getWorldObj().getBlockId(tileentity.xCoord, tileentity.yCoord,
				tileentity.zCoord) == Blocks.Padellone.blockID) {
		...
		bindTextureByName("/eyecandycraft/textures/Padellone.png");
		Padellone.render((Entity) null, 0.0F, -0.1F, 0.0F, 0.0F, 0.0F, 0.0625F);
