...
import eyecandycraft.main.solid.models.ModelPanchinaSinistra;

public class RenderTablePanchinaSinistra extends TileEntitySpecialRenderer {
	private ModelPanchinaSinistra PanchinaSinistra;

	public RenderTablePanchinaSinistra() {
		PanchinaSinistra = new ModelPanchinaSinistra();
	}
	...
	public void renderTileEntityAt(TileEntity tileentity, double x, double y, double z, float scale) {
		...
		if (tileentity.getWorldObj().getBlockId(tileentity.xCoord, tileentity.yCoord,
				tileentity.zCoord) == Blocks.PanchinaSinistra.blockID) {
		...
		bindTextureByName("/eyecandycraft/textures/Panchina.png");
		PanchinaSinistra.render((Entity) null, 0.0F, -0.1F, 0.0F, 0.0F, 0.0F, 0.0625F);
