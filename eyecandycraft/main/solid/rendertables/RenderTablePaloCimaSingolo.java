...
public class RenderTablePaloCimaSingolo extends TileEntitySpecialRenderer {
	private ModelPaloCimaSingolo PaloCimaSingolo;
	...
	public void renderTileEntityAt(TileEntity tileentity, double x, double y, double z, float scale) {
		...
		if (tileentity.getWorldObj().getBlockId(tileentity.xCoord, tileentity.yCoord,
				tileentity.zCoord) == Blocks.PaloCimaSingolo.blockID) {
		...
		PaloCimaSingolo.render((Entity) null, 0.0F, -0.1F, 0.0F, 0.0F, 0.0F, 0.0625F);
