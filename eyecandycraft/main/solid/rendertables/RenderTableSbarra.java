...
public class RenderTableSbarra extends TileEntitySpecialRenderer {
	private ModelSbarra Sbarra;

	public RenderTableSbarra() {
		Sbarra = new ModelSbarra();
	}
	...
	public void renderTileEntityAt(TileEntity tileentity, double x, double y, double z, float scale) {
		...
		if (tileentity.getWorldObj().getBlockId(tileentity.xCoord, tileentity.yCoord,
				tileentity.zCoord) == Blocks.Sbarra.blockID) {
		...
		Sbarra.render((Entity) null, 0.0F, -0.1F, 0.0F, 0.0F, 0.0F, 0.0625F);
