...
import eyecandycraft.main.solid.models.ModelPanchinaCentro;

public class RenderTablePanchinaCentro extends TileEntitySpecialRenderer {
	private ModelPanchinaCentro PanchinaCentro;

	public RenderTablePanchinaCentro() {
		PanchinaCentro = new ModelPanchinaCentro();
	}
	...
	public void renderTileEntityAt(TileEntity tileentity, double x, double y, double z, float scale) {
		...
		if (tileentity.getWorldObj().getBlockId(tileentity.xCoord, tileentity.yCoord,
				tileentity.zCoord) == Blocks.PanchinaCentro.blockID) {
		...
		PanchinaCentro.render((Entity) null, 0.0F, -0.1F, 0.0F, 0.0F, 0.0F, 0.0625F);
