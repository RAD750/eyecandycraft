...
public class ModelTraliccioBraccettoSingolo extends ModelBase {
		  ...
		  //fields
		    ...
		    ModelRenderer Gomito;
	
		  
		  public ModelTraliccioBraccettoSingolo()
		  {
		    textureWidth = 32;
		    textureHeight = 32;
		      ...
		      Braccetto.addBox(0F, 0F, 0F, 14, 1, 1);
		      Braccetto.setRotationPoint(3F, 10F, -0.5F);
		      ...
		      Gancio.setRotationPoint(2F, 9F, -1.5F);
		      Gancio.setTextureSize(64, 32);
		      Gancio.mirror = true;
		      setRotation(Gancio, 0F, 0F, 0F);
		      Gomito = new ModelRenderer(this, 21, 0);
		      Gomito.addBox(0F, 0F, 0F, 1, 2, 1);
		      Gomito.setRotationPoint(15.5F, 8F, -0.5F);
		      Gomito.setTextureSize(32, 32);
		      Gomito.mirror = true;
		      setRotation(Gomito, 0F, 0F, 0F);
		  }
