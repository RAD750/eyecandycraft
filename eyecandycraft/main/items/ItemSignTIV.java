...
public class ItemSignTIV extends ItemSign {

	public final Block signPost;
	public final Block signWall;
	
	public ItemSignTIV(int id, Block signPost, Block signWall) {
		super(id);
	...
	public boolean onItemUse(ItemStack par1ItemStack, EntityPlayer par2EntityPlayer, World par3World, int par4, int par5, int par6, int par7, float par8, float par9, float par10)
    {
        if (par7 == 0) {
            ...
            if (!par2EntityPlayer.canPlayerEdit(par4, par5, par6, par7, par1ItemStack)) {
                ...
                TileEntitySignTIV var12 = (TileEntitySignTIV)par3World.getBlockTileEntity(par4, par5, par6);
