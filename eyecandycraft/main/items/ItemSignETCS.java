...
import eyecandycraft.main.gui.GuiEditSignETCS;
...
public class ItemSignETCS extends ItemSign {

	public final Block signPost;
	public final Block signWall;
	
	public ItemSignETCS(int id, Block signPost, Block signWall) {
		super(id);
	...
	public void callGui(TileEntitySignCustom var12) {
		Minecraft.getMinecraft().displayGuiScreen(new GuiEditSignETCS(var12));
	}
	...
	public boolean onItemUse(ItemStack par1ItemStack, EntityPlayer par2EntityPlayer, World par3World, int par4, int par5, int par6, int par7, float par8, float par9, float par10)
    {
        if (par7 == 0) {
            ...
            if (!par2EntityPlayer.canPlayerEdit(par4, par5, par6, par7, par1ItemStack)) {
                ...
                TileEntitySignETCS var12 = (TileEntitySignETCS)par3World.getBlockTileEntity(par4, par5, par6);
