...
public class LampadarioBlock extends BlockContainer {
	public static final String name = "Lampadario";

	public LampadarioBlock(int id, int texture) {
	...
	public TileEntity createTileEntity(World world, int meta) {
		return new TileEntityLampadario();
	}
}
