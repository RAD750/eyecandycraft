...
public class ROEBlock extends BlockContainer {
	public static final String name = "ROE";

	public ROEBlock(int id, int texture) {
	...
	public void onBlockPlacedBy(World world, int x, int y, int z, EntityLiving entity) {
		if ((entity instanceof EntityPlayer)) {
			...
			world.setBlockAndMetadataWithNotify(x, y, z, Blocks.ROE.blockID, facing / 2);
		}
	}
