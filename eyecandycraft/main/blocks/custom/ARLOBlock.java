...
public class ARLOBlock extends BlockContainer {
	public static final String name = "ARLO";

	public ARLOBlock(int id, int texture) {
	...
	public void onBlockPlacedBy(World world, int x, int y, int z, EntityLiving entity) {
		if ((entity instanceof EntityPlayer)) {
			...
			world.setBlockAndMetadataWithNotify(x, y, z, Blocks.ARLO.blockID, facing / 2);
		}
	}
