...
public class AntennaSettore900MHzBlock extends BlockContainer {
	public static final String name = "AntennaSettore900MHz";

	public AntennaSettore900MHzBlock(int id, int texture) {
	...
	public TileEntity createTileEntity(World world, int meta) {
		return new TileEntityAntennaSettore900MHz();
	}
}
