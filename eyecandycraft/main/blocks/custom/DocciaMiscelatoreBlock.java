...
public class DocciaMiscelatoreBlock extends BlockContainer {
	public static final String name = "DocciaMiscelatore";

	public DocciaMiscelatoreBlock(int id, int texture) {
		super(id, Material.iron);
		setHardness(0.5F);
		setResistance(0.5F);
		setStepSound(Block.soundMetalFootstep);
		setCreativeTab(CreativeTab.tabEyecandyMobilio);
		setBlockName("DocciaMiscelatore");
		blockIndexInTexture = 82;
	}
	...
	public void onBlockPlacedBy(World world, int x, int y, int z, EntityLiving entity) {
		if ((entity instanceof EntityPlayer)) {
			...
			world.setBlockAndMetadataWithNotify(x, y, z, Blocks.DocciaMiscelatore.blockID, facing / 2);
		}
	}
	...
	public TileEntity createTileEntity(World world, int meta) {
		return new TileEntityDocciaMiscelatore();
	}
}
