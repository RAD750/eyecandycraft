...
public class NeonMuroBlock extends BlockContainer {
	public static final String name = "NeonMuro";

	public NeonMuroBlock(int id, int texture) {
		super(id, Material.iron);
		setHardness(0.5F);
		setResistance(0.5F);
		setStepSound(Block.soundMetalFootstep);
		setCreativeTab(CreativeTab.tabEyecandyMobilio);
		setBlockName("NeonMuro");
		setLightValue(1.0F);
		blockIndexInTexture = 91;
	}
	...
	public void onBlockPlacedBy(World world, int x, int y, int z, EntityLiving entity) {
		if ((entity instanceof EntityPlayer)) {
			...
			world.setBlockAndMetadataWithNotify(x, y, z, Blocks.NeonMuro.blockID, facing / 2);
		}
	}
