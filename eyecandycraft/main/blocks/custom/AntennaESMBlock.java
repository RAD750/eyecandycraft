...
public class AntennaESMBlock extends BlockContainer {
	public static final String name = "AntennaESM";

	public AntennaESMBlock(int id, int texture) {
		super(id, Material.iron);
		setHardness(0.5F);
		setResistance(0.5F);
		setStepSound(Block.soundMetalFootstep);
		setCreativeTab(CreativeTab.tabEyecandyMobilio);
		setBlockName("AntennaESM");
		blockIndexInTexture = 71;
	}
	...
	public TileEntity createTileEntity(World world, int meta) {
		return new TileEntityAntennaESM();
	}
}
