...
public class EstensioneSingolaBTSBlock extends BlockContainer {
	public static final String name = "EstensioneSingolaBTS";

	public EstensioneSingolaBTSBlock(int id, int texture) {
		super(id, Material.iron);
		setHardness(0.5F);
		setResistance(0.5F);
		setStepSound(Block.soundMetalFootstep);
		setCreativeTab(CreativeTab.tabEyecandyMobilio);
		setBlockName("EstensioneSingolaBTS");
	...
	public void onBlockPlacedBy(World world, int x, int y, int z, EntityLiving entity) {
		if ((entity instanceof EntityPlayer)) {
			...
			world.setBlockAndMetadataWithNotify(x, y, z, Blocks.EstensioneSingolaBTS.blockID, facing / 2);
		}
	}
	...
	public TileEntity createTileEntity(World world, int meta) {
		return new TileEntityEstensioneSingolaBTS();
	}
}
