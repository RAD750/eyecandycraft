...
public class MiniARLOBlock extends BlockContainer {
	public static final String name = "MiniARLO";

	public MiniARLOBlock(int id, int texture) {
		super(id, Material.iron);
		setHardness(0.5F);
		setResistance(0.5F);
		setStepSound(Block.soundMetalFootstep);
		setCreativeTab(CreativeTab.tabEyecandyMobilio);
		setBlockName("MiniARLO");
		blockIndexInTexture = 68;
	}
	...
	public void onBlockPlacedBy(World world, int x, int y, int z, EntityLiving entity) {
		if ((entity instanceof EntityPlayer)) {
			...
			world.setBlockAndMetadataWithNotify(x, y, z, Blocks.MiniARLO.blockID, facing / 2);
		}
	}
