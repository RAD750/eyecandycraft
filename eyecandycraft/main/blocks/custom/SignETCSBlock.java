...
public class SignETCSBlock extends BlockSign {

	public final int itemID;
	public final BlockSign blockPost;
	public final String textureFile;
	
	public SignETCSBlock(int id, boolean isFreestanding, int itemID, Block blockPost, String textureFile) {
    ...
    public boolean onBlockActivated(World world, int x, int y, int z, EntityPlayer player, int side, float par6, float par7, float par8) {
		TileEntitySignETCS sign = (TileEntitySignETCS)world.getBlockTileEntity((int)x, (int)y, (int)z);
