...
public class BombolaGasBlock extends BlockContainer {
	public static final String name = "BombolaGas";

	public BombolaGasBlock(int id, int texture) {
		super(id, Material.iron);
		setHardness(0.5F);
		setResistance(0.5F);
		setStepSound(Block.soundMetalFootstep);
		setCreativeTab(CreativeTab.tabEyecandyMobilio);
		setBlockName("BombolaGas");
		blockIndexInTexture = 46;
	}
	...
	public TileEntity createTileEntity(World world, int meta) {
		return new TileEntityBombolaGas();
	}
}
