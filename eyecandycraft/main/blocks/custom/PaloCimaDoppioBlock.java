...
public class PaloCimaDoppioBlock extends BlockContainer {
	public static final String name = "PaloCimaDoppio";

	public PaloCimaDoppioBlock(int id, int texture) {
		super(id, Material.iron);
		setHardness(0.5F);
		setResistance(0.5F);
		setStepSound(Block.soundMetalFootstep);
		setCreativeTab(CreativeTab.tabEyecandyMobilio);
		setBlockName("PaloCimaDoppio");
	...
	public void onBlockPlacedBy(World world, int x, int y, int z, EntityLiving entity) {
		if ((entity instanceof EntityPlayer)) {
			...
			world.setBlockAndMetadataWithNotify(x, y, z, Blocks.PaloCimaDoppio.blockID, facing / 2);
		}
	}
	...
	public TileEntity createTileEntity(World world, int meta) {
		return new TileEntityPaloCimaDoppio();
	}
