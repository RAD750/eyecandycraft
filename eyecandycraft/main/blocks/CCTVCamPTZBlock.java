...
public class CCTVCamPTZBlock extends BlockContainer {
	public static final String name = "CCTVCamPTZ";

	public CCTVCamPTZBlock(int id, int texture) {
	...
	public void onBlockPlacedBy(World world, int x, int y, int z, EntityLiving entity) {
		if ((entity instanceof EntityPlayer)) {
			...
			world.setBlockAndMetadataWithNotify(x, y, z, Blocks.CCTVCamPTZ.blockID, facing / 2);
		}
	}
	...
	public TileEntity createTileEntity(World world, int meta) {
		return new TileEntityCCTVCamPTZ();
	}
}
