package eyecandycraft.main.gui;
...
public class GuiEditSignETCS extends GuiScreen {
    /**
    ...
    protected String screenTitle = "Edit ETCS marker:";

    /** Reference to the sign object. */
    private TileEntitySignCustom entitySign;

    /** Counts the number of screen updates. */
    //private int updateCounter;

    /** The number of the line that is being edited. */
    private int editLine = 3;

    public GuiEditSignETCS(TileEntitySignCustom par1TileEntitySign)
    {
    ...
    public void onGuiClosed()
    {
        ...
        if (var1 != null)
        {
            var1.addToSendQueue(this.entitySign.getDescriptionPacket());
        }
    ...
    protected void keyTyped(char par1, int par2) {
        ...
        if (allowedCharacters.indexOf(par1) >= 0 && 
        		ChatColor.stripColor(ChatColor.translateAlternateColorCodes('&', this.entitySign.signText[this.editLine])).length() < 15) {
    ...
    public void drawScreen(int par1, int par2, float par3) {
        ...
        if (var5.equals(entitySign.getBlockPost())) {
