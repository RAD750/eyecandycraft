...
import eyecandycraft.main.solid.models.ModelSignETCS;
import eyecandycraft.main.solid.models.ModelSignTIV;
import eyecandycraft.main.utils.ChatColor;

public class TileEntitySignETCSCustomRenderer extends TileEntitySignRenderer {

    private ModelSignETCS modelSign = new ModelSignETCS();
    private int updateCounter;
    
	@Override
	public void renderTileEntitySignAt(TileEntitySign signPar, double par2, double par4, double par6, float par8) {
		updateCounter++;
		TileEntitySignETCS sign = (TileEntitySignETCS) signPar;
