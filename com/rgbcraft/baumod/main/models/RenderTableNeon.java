...
import com.rgbcraft.baumod.main.blocks.NeonBlock;

public class RenderTableNeon extends TileEntitySpecialRenderer {
	private ModelNeon Neon;

	public RenderTableNeon() {
		Neon = new ModelNeon();
	}
	...
	public void renderTileEntityAt(TileEntity tileentity, double x, double y, double z, float scale) {
		...
		if (tileentity.getWorldObj().getBlockId(tileentity.xCoord, tileentity.yCoord,
				tileentity.zCoord) == Blocks.Neon.blockID) {
		...
		bindTextureByName("/com/rgbcraft/baumod/textures/Neon.png");
