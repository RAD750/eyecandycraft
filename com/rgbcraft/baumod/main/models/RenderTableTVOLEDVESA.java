...
public class RenderTableTVOLEDVESA extends TileEntitySpecialRenderer {
	private ModelTVOLEDVESA TVOLEDVESA;

	public RenderTableTVOLEDVESA() {
		TVOLEDVESA = new ModelTVOLEDVESA();
	}
	...
	public void renderTileEntityAt(TileEntity tileentity, double x, double y, double z, float scale) {
		...
		if (tileentity.getWorldObj().getBlockId(tileentity.xCoord, tileentity.yCoord,
				tileentity.zCoord) == Blocks.TVOLEDVESA.blockID) {
		...
		bindTextureByName("/com/rgbcraft/baumod/textures/TVOLED.png");
		TVOLEDVESA.render((Entity) null, 0.0F, -0.1F, 0.0F, 0.0F, 0.0F, 0.0625F);
