...
import com.rgbcraft.baumod.main.blocks.FaroBlock;

public class RenderTableFaro extends TileEntitySpecialRenderer {
	private ModelFaro Faro;

	public RenderTableFaro() {
		Faro = new ModelFaro();
	}
	...
	public void renderTileEntityAt(TileEntity tileentity, double x, double y, double z, float scale) {
		...
		if (tileentity.getWorldObj().getBlockId(tileentity.xCoord, tileentity.yCoord,
				tileentity.zCoord) == Blocks.Faro.blockID) {
		...
		bindTextureByName("/com/rgbcraft/baumod/textures/Faro.png");
		Faro.render((Entity) null, 0.0F, -0.1F, 0.0F, 0.0F, 0.0F, 0.0625F);
