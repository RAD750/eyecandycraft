...
import com.rgbcraft.baumod.main.blocks.RackRFBlock;

public class RenderTableRackRF extends TileEntitySpecialRenderer {
	private ModelRackRF RackRF;

	public RenderTableRackRF() {
		RackRF = new ModelRackRF();
	}
	...
	public void renderTileEntityAt(TileEntity tileentity, double x, double y, double z, float scale) {
		...
		if (tileentity.getWorldObj().getBlockId(tileentity.xCoord, tileentity.yCoord,
				tileentity.zCoord) == Blocks.RackRF.blockID) {
		...
		bindTextureByName("/com/rgbcraft/baumod/textures/RackRF.png");
		RackRF.render((Entity) null, 0.0F, -0.1F, 0.0F, 0.0F, 0.0F, 0.0625F);
