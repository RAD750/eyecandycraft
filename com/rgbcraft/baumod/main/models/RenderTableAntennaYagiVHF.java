...
public class RenderTableAntennaYagiVHF extends TileEntitySpecialRenderer {
	private ModelAntennaYagiVHF AntennaYagiVHF;
	...
	public void renderTileEntityAt(TileEntity tileentity, double x, double y, double z, float scale) {
		...
		if (tileentity.getWorldObj().getBlockId(tileentity.xCoord, tileentity.yCoord,
				tileentity.zCoord) == Blocks.AntennaYagiVHF.blockID) {
		...
		bindTextureByName("/com/rgbcraft/baumod/textures/AntennaYagiVHF.png");
		AntennaYagiVHF.render((Entity) null, 0.0F, -0.1F, 0.0F, 0.0F, 0.0F, 0.0625F);
