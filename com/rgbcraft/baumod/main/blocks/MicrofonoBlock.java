...
import com.rgbcraft.baumod.main.entities.TileEntityMicrofono;
...
public class MicrofonoBlock extends BlockContainer {
	public static final String name = "Microfono";

	public MicrofonoBlock(int id, int texture) {
		super(id, Material.iron);
		setHardness(0.5F);
		setResistance(0.5F);
		setStepSound(Block.soundMetalFootstep);
		setCreativeTab(CreativeHandler.ECCDecorations);
		setBlockName("Microfono");
	...
	public void onBlockPlacedBy(World world, int x, int y, int z, EntityLiving entity) {
		if ((entity instanceof EntityPlayer)) {
			...
			world.setBlockAndMetadataWithNotify(x, y, z, Blocks.Microfono.blockID, facing / 2);
		}
	}
	...
	public TileEntity createTileEntity(World world, int meta) {
		return new TileEntityMicrofono();
	}
}
