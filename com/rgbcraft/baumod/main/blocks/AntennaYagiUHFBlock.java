...
import com.rgbcraft.baumod.main.entities.TileEntityAntennaYagiUHF;
...
public class AntennaYagiUHFBlock extends BlockContainer {
	public static final String name = "AntennaYagiUHF";

	public AntennaYagiUHFBlock(int id, int texture) {
		super(id, Material.iron);
		setHardness(0.5F);
		setResistance(0.5F);
		setStepSound(Block.soundMetalFootstep);
		setCreativeTab(CreativeHandler.ECCDecorations);
		setBlockName("AntennaYagiUHF");
	...
	public void onBlockPlacedBy(World world, int x, int y, int z, EntityLiving entity) {
		if ((entity instanceof EntityPlayer)) {
			...
			world.setBlockAndMetadataWithNotify(x, y, z, Blocks.AntennaYagiUHF.blockID, facing / 2);
		}
	}
	...
	public TileEntity createTileEntity(World world, int meta) {
		return new TileEntityAntennaYagiUHF();
	}
}
