...
import com.rgbcraft.baumod.main.entities.TileEntityFaro;
...
public class FaroBlock extends BlockContainer {
	public static final String name = "Faro";

	public FaroBlock(int id, int texture) {
	...
	public void onBlockPlacedBy(World world, int x, int y, int z, EntityLiving entity) {
		if ((entity instanceof EntityPlayer)) {
			...
			world.setBlockAndMetadataWithNotify(x, y, z, Blocks.Faro.blockID, facing / 2);
		}
	}
