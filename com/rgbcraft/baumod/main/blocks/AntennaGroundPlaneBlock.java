...
import com.rgbcraft.baumod.main.entities.TileEntityAntennaGroundPlane;
...
public class AntennaGroundPlaneBlock extends BlockContainer {
	public static final String name = "AntennaGroundPlane";

	public AntennaGroundPlaneBlock(int id, int texture) {
		super(id, Material.iron);
		setHardness(0.5F);
		setResistance(0.5F);
		setStepSound(Block.soundMetalFootstep);
		setCreativeTab(CreativeTab.CTDecorations);
		setBlockName("AntennaGroundPlane");
	...
	public TileEntity createTileEntity(World world, int meta) {
		return new TileEntityAntennaGroundPlane();
	}
}
