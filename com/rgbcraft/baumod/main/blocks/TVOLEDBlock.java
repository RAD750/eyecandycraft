...
import com.rgbcraft.baumod.main.entities.TileEntityTVOLED;
...
public class TVOLEDBlock extends BlockContainer {
	public static final String name = "TVOLED";

	public TVOLEDBlock(int id, int texture) {
	...
	public void onBlockPlacedBy(World world, int x, int y, int z, EntityLiving entity) {
		if ((entity instanceof EntityPlayer)) {
			...
			world.setBlockAndMetadataWithNotify(x, y, z, Blocks.TVOLED.blockID, facing / 2);
		}
	}
