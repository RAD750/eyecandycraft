...
import com.rgbcraft.baumod.main.entities.TileEntityParabolaSat;
...
public class ParabolaBlock extends BlockContainer {
	public static final String name = "ParabolaSat";

	public ParabolaBlock(int id, int texture) {
		super(id, Material.iron);
		setHardness(0.5F);
		setResistance(0.5F);
		setStepSound(Block.soundMetalFootstep);
		setCreativeTab(CreativeHandler.ECCDecorations);
		setBlockName("ParabolaSat");
	...
	public TileEntity createTileEntity(World world, int meta) {
		return new TileEntityParabolaSat();
	}
}
